(function() { // private module pattern
  ...
  var FPS           = 60,                                                   // 'update' frame rate fixed at 60fps independent of rendering loop
      ...
      PLAYER_WIDTH  = METER * 2,                                          // player logical width
      ...
      PLAYER        = { DEBUG: false,                                       // enable player debug rendering (bounding box and collision points)
        RIGHT: { x: 0,  y: 714, w: 64, h: 52, frames: 9, fps: 15 },        // animation - player running right
        STAND: { x: 0,  y: 1290, w: 64, h: 52, frames: 1,  fps: 30 },        // animation - player standing still
        LEFT:  { x: 0, y: 586, w: 64, h: 52, frames: 9, fps: 15 },        // animation - player running left
        BACK:  { x: 384, y: 10, w: 64, h: 52, frames: 1,  fps: 30 },        // animation - player standing still with back to camera (on ladder but not moving)
        CLIMB: { x: 0, y: 522, w: 64, h: 52, frames: 9, fps: 15 },        // animation - player climbing ladder
        HURTL: { x: 0, y: 1290, w: 64, h: 52, frames: 6,  fps: 10 },        // animation - player hurt while running left
        HURTR: { x: 0, y: 1290, w: 64, h: 52, frames: 6,  fps: 10 },         // animation - player hurt while running right
